...
public class Configuration
{
	...
	public final class PairedLimit
	{
		...
		{
			return String.format((this.minimum == this.maximum ? "%,d" : "%,d..%,d"), this.minimum, this.maximum);
		} // end toString()
	...
	public final class RouteSpec
	{
		...
		public String toString()
		{
			return String.format("%s with length %,d", this.style.toString(), this.length);
		} // end toString()
	...
	public final class TrainSpec
	{
		...
		public String toString()
		{
			return String.format("%s at location %,d with capacity %,d", this.direction.toString(), this.location,
					this.capacity);
		} // end toString()
	} // end class TrainSpec
	...
	public Configuration(String configFilename) throws FileNotFoundException
	{
		...
		while (input.hasNextLine())
		{
			...
			// add the parameter to the map - replaces any previous
			// specification
	...
	public PairedLimit[] getPassengers()
	{
		...
		// retrieve the specification string and break it into its
	...
	{
		// the specification is a comma-separated list of positive, non-zero
		// whole numbers
	...
	public TrainSpec[] getTrains()
	{
		...
		// allocate an array large enough to hold all of the Train
		// specifications
