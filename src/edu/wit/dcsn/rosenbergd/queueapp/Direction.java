...
public enum Direction
{
	...
	public static void main(String[] args)
	{
		...
		System.out.printf("%-5s %-20s %-20s %-20s %-20s%n", "#", "Name", "Direction", "Display Text", "Parsed");

		// display each element of the enumeration
		for (Direction aDirection : Direction.values())
		{
			System.out.printf("%-5d %-20s %-20s %-20s %-20s%n", aDirection.ordinal(), aDirection.name(), aDirection,
					aDirection.displayText, Direction.parse(aDirection.displayText));
		}
